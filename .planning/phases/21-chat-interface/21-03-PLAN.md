...
<task type="auto">
  ...
  <verify>
    Check chat-page.tsx exists and exports ChatPage component. Verify MessageBubble, TypingIndicator components are defined. Check imports of useStreamingChat, useCoachMessages, usePatternAnalysis are present.
  </verify>
  <done>
