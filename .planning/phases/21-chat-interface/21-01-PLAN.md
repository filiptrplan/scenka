...
<task type="auto">
  ...
  <verify>
    Run Deno eval "import { getChatSystemPrompt } from './supabase/functions/_shared/system-prompt.ts'; console.log(getChatSystemPrompt({}))" should return non-empty string with climbing coach role description
  </verify>
  <done>
