...
must_haves:
  truths:
    - "ProjectingFocus interface defined with all required fields"
    - "GenerateRecommendationsResponse includes projecting_focus array"
    - "generateRecommendations returns projecting_focus from API response"
