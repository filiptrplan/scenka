...
import { STYLE_OPTIONS, getFailureReasons } from '@/lib/constants/styles'
  ...
  ({ open, onOpenChange, onSubmit, isSaving, climb }, ref) => {
    ...
    const {
      ...
      defaultValues: {
        ...
        style: [],
        failure_reasons: [],
        location: profile?.home_gym ?? DEFAULT_LOCATION,
            ...
            >
                        ...
                        {profile.enabled_hold_colors.map((color) => {
                          return (
                            <button
                              ...
                              style={{ backgroundColor: HOLD_COLOR_MAP[color as HoldColor] }}
              ...
              <div className="space-y-4 pt-4 border-t border-white/10">
                ...
                {!hideFailureReasons && (
                  <div className="space-y-2">
                    <FormLabel>
                      {outcome === 'Fail' ? 'Failure Reasons' : 'Imperfect Aspects'} (select all
                      that apply)
                    </FormLabel>
                    <div className="flex flex-wrap gap-2">
                ...
                <div className="space-y-2">
                  <div className="space-y-1">
                    ...
                    {hideFailureReasons ? <p className="text-xs text-white/30">
                        Describe the climb in detail - AI will analyze these notes to extract style
                        and failure reasons
                      </p> : null}
                  </div>
                  <Textarea
